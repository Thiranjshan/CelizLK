  ...
  return <>
    ...
    {canEdit && <form className="admin-form-panel" onSubmit={save}>
      ...
      <div className="admin-form-grid">
        ...
        <label className="admin-form-wide">Description<textarea required minLength={10} rows={4} value={form.description} onChange={(event) => setForm({ ...form, description: event.target.value })} /></label>
        <label className="admin-form-wide">Technical specifications<textarea rows={6} value={form.specs} onChange={(event) => setForm({ ...form, specs: event.target.value })} placeholder="Enter the technical specifications for this product" /></label>
      </div>
